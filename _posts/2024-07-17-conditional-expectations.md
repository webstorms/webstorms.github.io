...
\end{aligned}$$ Et voila! It's the same answer. Let's take a look at a more challenging problem.
...
&= 7\\
\end{aligned}$$ Here we include the expectation in the second term as we get to play the game again.
